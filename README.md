...
Panel to date (**<!--panel:snapshots-->447<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~110h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->2235<!--/panel:n_obs--> complete observations:
**min <!--panel:cost_min-->0.994<!--/panel:cost_min-->, median
<!--panel:cost_median-->1.021<!--/panel:cost_median-->, max
<!--panel:cost_max-->1.280<!--/panel:cost_max-->**;
**<!--panel:sub_dollar-->125/2235<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->5.6%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~110h<!--/panel:hours--> /
  <!--panel:snapshots-->447<!--/panel:snapshots-->+ snapshots so far (and still
