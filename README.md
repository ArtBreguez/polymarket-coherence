...
Panel to date (**<!--panel:snapshots-->511<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~124h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->2555<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->129/2555<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->5.0%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~124h<!--/panel:hours--> /
  <!--panel:snapshots-->511<!--/panel:snapshots-->+ snapshots so far (and still
