...
Panel to date (**<!--panel:snapshots-->535<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~130h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->2675<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->129/2675<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~130h<!--/panel:hours--> /
  <!--panel:snapshots-->535<!--/panel:snapshots-->+ snapshots so far (and still
