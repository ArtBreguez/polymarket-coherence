...
Panel to date (**<!--panel:snapshots-->711<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->3555<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->155/3555<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->711<!--/panel:snapshots-->+ snapshots so far (and still
