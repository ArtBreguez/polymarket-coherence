...
Panel to date (**<!--panel:snapshots-->702<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~171h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->3510<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->146/3510<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~171h<!--/panel:hours--> /
  <!--panel:snapshots-->702<!--/panel:snapshots-->+ snapshots so far (and still
