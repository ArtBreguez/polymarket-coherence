...
Panel to date (**<!--panel:snapshots-->853<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~209h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->4265<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->277/4265<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~209h<!--/panel:hours--> /
  <!--panel:snapshots-->853<!--/panel:snapshots-->+ snapshots so far (and still
