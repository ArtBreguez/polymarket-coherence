...
Panel to date (**<!--panel:snapshots-->949<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~233h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->4745<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->382/4745<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->8.1%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~233h<!--/panel:hours--> /
  <!--panel:snapshots-->949<!--/panel:snapshots-->+ snapshots so far (and still
