...
Panel to date (**<!--panel:snapshots-->564<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->2820<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->129/2820<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->564<!--/panel:snapshots-->+ snapshots so far (and still
