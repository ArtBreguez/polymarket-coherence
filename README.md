...
Panel to date (**<!--panel:snapshots-->843<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->4215<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->267/4215<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->6.3%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->843<!--/panel:snapshots-->+ snapshots so far (and still
