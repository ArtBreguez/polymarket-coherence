...
Panel to date (**<!--panel:snapshots-->198<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~48h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->990<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->77/990<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->7.8%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~48h<!--/panel:hours--> /
  <!--panel:snapshots-->198<!--/panel:snapshots-->+ snapshots so far (and still
