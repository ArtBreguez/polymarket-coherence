...
Panel to date (**<!--panel:snapshots-->192<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->960<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->71/960<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->7.4%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->192<!--/panel:snapshots-->+ snapshots so far (and still
