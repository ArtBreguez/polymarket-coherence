...
Panel to date (**<!--panel:snapshots-->572<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~139h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->2860<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->129/2860<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->4.5%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~139h<!--/panel:hours--> /
  <!--panel:snapshots-->572<!--/panel:snapshots-->+ snapshots so far (and still
