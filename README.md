...
Panel to date (**<!--panel:snapshots-->345<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~84h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->1725<!--/panel:n_obs--> complete observations:
**min <!--panel:cost_min-->0.994<!--/panel:cost_min-->, median
<!--panel:cost_median-->1.022<!--/panel:cost_median-->, max
<!--panel:cost_max-->1.266<!--/panel:cost_max-->**;
**<!--panel:sub_dollar-->125/1725<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~84h<!--/panel:hours--> /
  <!--panel:snapshots-->345<!--/panel:snapshots-->+ snapshots so far (and still
