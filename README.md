...
Panel to date (**<!--panel:snapshots-->186<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->930<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->65/930<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->7.0%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->186<!--/panel:snapshots-->+ snapshots so far (and still
