...
Panel to date (**<!--panel:snapshots-->693<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->3465<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->137/3465<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->693<!--/panel:snapshots-->+ snapshots so far (and still
