...
Panel to date (**<!--panel:snapshots-->924<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~227h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->4620<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->341/4620<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~227h<!--/panel:hours--> /
  <!--panel:snapshots-->924<!--/panel:snapshots-->+ snapshots so far (and still
