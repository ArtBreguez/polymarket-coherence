...
Panel to date (**<!--panel:snapshots-->189<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->945<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->68/945<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->7.2%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->189<!--/panel:snapshots-->+ snapshots so far (and still
