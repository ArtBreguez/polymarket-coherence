...
Panel to date (**<!--panel:snapshots-->773<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->3865<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->201/3865<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->773<!--/panel:snapshots-->+ snapshots so far (and still
