...
Panel to date (**<!--panel:snapshots-->254<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~62h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->1270<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->125/1270<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->9.8%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~62h<!--/panel:hours--> /
  <!--panel:snapshots-->254<!--/panel:snapshots-->+ snapshots so far (and still
