...
Panel to date (**<!--panel:snapshots-->583<!--/panel:snapshots-->+ snapshots**
over <!--panel:hours-->~142h<!--/panel:hours--> and still growing, order size
...
cost over all <!--panel:n_obs-->2915<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->129/2915<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:hours-->~142h<!--/panel:hours--> /
  <!--panel:snapshots-->583<!--/panel:snapshots-->+ snapshots so far (and still
