...
Panel to date (**<!--panel:snapshots-->291<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->1455<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->125/1455<!--/panel:sub_dollar-->
(<!--panel:sub_dollar_pct-->8.6%<!--/panel:sub_dollar_pct-->)** were sub-\$1 — all
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->291<!--/panel:snapshots-->+ snapshots so far (and still
