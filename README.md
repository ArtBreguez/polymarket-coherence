...
Panel to date (**<!--panel:snapshots-->677<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->3385<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->129/3385<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->677<!--/panel:snapshots-->+ snapshots so far (and still
