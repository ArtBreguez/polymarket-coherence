...
Panel to date (**<!--panel:snapshots-->780<!--/panel:snapshots-->+ snapshots**
...
cost over all <!--panel:n_obs-->3900<!--/panel:n_obs--> complete observations:
...
**<!--panel:sub_dollar-->205/3900<!--/panel:sub_dollar-->
...
- **Parts 1–2 are cross-sectional; Part 3 is a young panel.** The Gamma API does
  ...
  <!--panel:snapshots-->780<!--/panel:snapshots-->+ snapshots so far (and still
