...
A scheduled collector (every 15 min) has built a panel of **<!--panel:snapshots-->589<!--/panel:snapshots-->+ snapshots** over
<!--panel:hours-->~143h<!--/panel:hours--> (and still growing) across <!--panel:distinct_events-->38<!--/panel:distinct_events--> events.
...
- Lock cost over all <!--panel:n_obs-->2945<!--/panel:n_obs--> complete observations: **min <!--panel:cost_min-->0.994<!--/panel:cost_min-->, median <!--panel:cost_median-->1.022<!--/panel:cost_median-->, max
  <!--panel:cost_max-->1.280<!--/panel:cost_max-->**. <!--panel:sub_dollar_of-->129 of 2945<!--/panel:sub_dollar_of--> (<!--panel:sub_dollar_pct-->4.4%<!--/panel:sub_dollar_pct-->) were sub-\$1, all in that one small dense field.
...
the edge is **marginal (≤0.6% gross) and confined to one field** (<!--panel:sub_dollar_of-->129 of 2945<!--/panel:sub_dollar_of--> complete observations, all in that single small dense market),
...
- **Snapshot + young panel.** Parts 1–2 are a cross-sectional snapshot;
  Part 3's panel is <!--panel:hours-->~143h<!--/panel:hours--> / <!--panel:snapshots-->589<!--/panel:snapshots-->+ snapshots (and still growing). The "rare,
