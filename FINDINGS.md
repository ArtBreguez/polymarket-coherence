...
<!--panel:hours-->~110h<!--/panel:hours--> (and still growing) across <!--panel:distinct_events-->38<!--/panel:distinct_events--> events.
...
- **Snapshot + young panel.** Parts 1–2 are a cross-sectional snapshot;
  Part 3's panel is <!--panel:hours-->~110h<!--/panel:hours--> / <!--panel:snapshots-->447<!--/panel:snapshots-->+ snapshots (and still growing). The "rare,
