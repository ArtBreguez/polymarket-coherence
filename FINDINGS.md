...
A scheduled collector (every 15 min) has built a panel of **<!--panel:snapshots-->428<!--/panel:snapshots-->+ snapshots** over
...
the edge is **marginal (≤0.6% gross) and confined to one field** (<!--panel:sub_dollar_of-->125 of 2140<!--/panel:sub_dollar_of--> complete observations, all in that single small dense market),
...
- **Snapshot + young panel.** Parts 1–2 are a cross-sectional snapshot;
  Part 3's panel is <!--panel:hours-->~105h<!--/panel:hours--> / <!--panel:snapshots-->428<!--/panel:snapshots-->+ snapshots (and still growing). The "rare,
