...
A scheduled collector (every 15 min) has built a panel of **<!--panel:snapshots-->246<!--/panel:snapshots-->+ snapshots** over
...
- Lock cost over all <!--panel:n_obs-->1230<!--/panel:n_obs--> complete observations: **min <!--panel:cost_min-->0.994<!--/panel:cost_min-->, median <!--panel:cost_median-->1.022<!--/panel:cost_median-->, max
  <!--panel:cost_max-->1.243<!--/panel:cost_max-->**. <!--panel:sub_dollar_of-->125 of 1230<!--/panel:sub_dollar_of--> (<!--panel:sub_dollar_pct-->10.2%<!--/panel:sub_dollar_pct-->) were sub-\$1, all in that one small dense field.
...
the edge is **marginal (≤0.6% gross) and confined to one field** (<!--panel:sub_dollar_of-->125 of 1230<!--/panel:sub_dollar_of--> complete observations, all in that single small dense market),
...
- **Snapshot + young panel.** Parts 1–2 are a cross-sectional snapshot;
  Part 3's panel is <!--panel:hours-->~60h<!--/panel:hours--> / <!--panel:snapshots-->246<!--/panel:snapshots-->+ snapshots (and still growing). The "rare,
